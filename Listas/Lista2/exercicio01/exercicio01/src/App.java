...
public class App {
    ...
    public static String formatarNome (String nome){
        ...
        String primeiraLetraNome = String.valueOf(primeiroNome.charAt(0));// charAt retorna o caractere, valueOf mudar de char para string.
        String primeiroNomeSemInicial = primeiroNome.substring(1); //desconsidera a primeira letra do nome
        String nomeFormatado = primeiraLetraNome.toUpperCase() + primeiroNomeSemInicial.toLowerCase();//transforma primeira letra em maiúscula e restante em minúsculo.
